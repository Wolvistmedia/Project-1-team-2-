    ...
    <div className="w-full py-12 px-4 md:px-10 lg:px-20">
      ...
      <div className=" flex flex-col  w-full    px-4 sm:px-6 md:px-10 lg:px-20">
        <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }} className="mb-12">
          ...
          <h2
            className="text-black/80 font-bold uppercase text-4xl sm:text-5xl md:text-6xl leading-tight">
            meet our team
          </h2>
        </motion.div>
      </div>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center gap-10">
        ...
        <motion.div
          ...
          className="relative max-w-2xl w-full h-75 md:h-90">
        ...
        <motion.div
          ...
          <button
            ...
            className="mt-6  bg-linear-to-r from-[#3A1A86] to-[#6A51A5] cursor-pointer text-white px-6 py-3 rounded-md hover:bg-blue-800 transition">
            Meet our Team
          </button>
        </motion.div>
